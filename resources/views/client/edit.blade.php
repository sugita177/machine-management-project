            ...
            <div class="pt-0 p-4 sm:pt-0 sm:p-7">
                ...
                <div class="space-y-4 sm:space-y-6">
                    <div class="space-y-2">
                        ...
                        <input disabled id="name" name="name" type="text" class="py-2 px-3 pr-11 block w-full border-gray-200 shadow-sm rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" placeholder="名前" value="{{old('name', $client->name)}}">
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea id="remark" name="remark" class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" rows="6" placeholder="備考" value="{{old('remark', $client->remark)}}"></textarea>
                    </div>
                </div>
